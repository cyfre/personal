...
const alphaCounts = { e: 9, t: 7, a: 7, o: 7, i: 6, n: 6, s: 6, r: 6, h: 5, d: 4, l: 3, u: 2, c: 2, m: 2, f: 2, y: 2, w: 2, g: 2, p: 1, b: 1, v: 0, k: 0, x: 0, q: 0, j: 0, z: 0 };
const alpha = Object.entries(lessE).map(pair =>
    initArr(Math.floor(Math.pow(pair[1], 1))+2, () => pair[0]).join('')).join('');
